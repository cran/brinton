...
warning_pandoc    <- "Warning: I'm so sorry but 'brinton' requires Pandoc v >= 1.12.3 (https://pandoc.org/)."
...
warning_wrong     <- "Apparently something is wrong."
warning_wp_dc     <- "Available datatypes are 'datetime', 'logical', 'factor', 'ordered', 'numeric' and 'character'"
